...
class Model : public QObject
{
  ...
  public:
    ...
    /**
     * @brief Get direct destination position of robot
     *
     * @return direct destination position of robot
     */
    QVector3D getDest();
    /**
     * @brief Get final destination position of robot
     *
     * @return final destination position of robot
     */
    QVector3D getFinalDest();

    /**
     * @brief Check whether ball is seen from localization information.
     *
     * @return whether ball is seen from localization information
     */
    bool getLocSeeball();
    /**
     * @brief Get ball position in robot coordinate from localization information.
     *
     * @return ball position in robot coordinate from localization information
     */
    QPointF getLocBallField();
    ...
    /**
     * @brief Get circle position in robot coordinate from localization information.
     *
     ...
     *
     * @return robot view range on field in robot coordinate from localization information
     */
     ...
     *
     * @return obstacle positions in robot coordinate from localization information
     */
  ...
  private:
    ...
    QVector3D robot_pos_loc_ = { 100, 100, 45 };
    //! motion delta in previous
    QVector3D prev_delta_ = { 0, 0, 0 };
    //! motion delta at present
    QVector3D motion_delta_ = { 0, 0, 0 };
    //! flag for whether ball is seen from localization information
    bool see_ball_loc_ = false;
    //! ball position in robot coordinate from localization information
    QPointF ball_field_loc_;
    ...
    //! robot view range on field in robot coordinate from localization information
  ...
  public:
    ...
    // bool srvSetYaw(dmsgs::SetInitOrientation::Request &req, dmsgs::SetInitOrientation::Response &res);

    // bool srvResetParticlesPoint(dmsgs::ResetParticlePoint::Request &req,
    //                             dmsgs::ResetParticlePoint::Response &res);

    // bool srvResetParticlesLeftTouch(dmsgs::ResetParticleLeftTouch::Request &req,
    //                                 dmsgs::ResetParticleLeftTouch::Response &res);

    // bool srvResetParticlesRightTouch(dmsgs::ResetParticleRightTouch::Request &req,
